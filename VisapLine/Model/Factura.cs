...
namespace VisapLine.Model
{
    public class Factura
    {
        ...
        public DataTable RegistrarFactura1(Factura fac)
        {
            return data.ConsultarDatos("select * from pr_insertarfactura(0001212121283,'" + fac.fechaemision + "','" + fac.fechavencimiento + "','" + fac.fechacorte + "'," + fac.facturaventa + ",'" + fac.estado + "','" + fac.cuotas + "'," + fac.contrato_idcontrato + ")");
        }
        ...
        public DataTable Consultarsecuencia()
        {
            return data.ConsultarDatos("select * from pr_consultarfacturasecuencia1()");
        }
    }
}