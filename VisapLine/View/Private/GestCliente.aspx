                    ...
                    <div class="box box-primary" id="paneldedatosterceros" runat="server" visible="false">
                        <div class="box-header with-border">
                            <h3 class="box-title">Informacion del cliente N°
                                <label runat="server" id="num"></label>
                            </h3>
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="ordenes">
                        <div class="box-body">
                            <asp:GridView CssClass="table table-bordered table-striped table-responsive" ID="listordenes" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None">
                                <AlternatingRowStyle BackColor="White"></AlternatingRowStyle>
